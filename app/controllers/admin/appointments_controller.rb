class Admin::AppointmentsController < Admin::BaseController
  ...
  STATUS_MAPPER = {
    pending: Proc.new { |appointment| AppointmentMailer.pending_email(appointment).deliver_now },
    confirmed: Proc.new { |appointment| AppointmentMailer.confirmation_email(appointment).deliver_now },
    cancelled: Proc.new { |appointment| AppointmentMailer.cancellation_email(appointment).deliver_now },
    completed: Proc.new { |appointment| AppointmentMailer.completion_email(appointment).deliver_now },
    no_show: Proc.new { |appointment| AppointmentMailer.no_show_email(appointment).deliver_now }
  }.freeze
